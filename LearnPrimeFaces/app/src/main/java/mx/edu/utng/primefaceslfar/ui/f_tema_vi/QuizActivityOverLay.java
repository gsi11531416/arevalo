 ...
 */
public class QuizActivityOverLay extends AppCompatActivity {
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                    Toast.makeText(QuizActivityOverLay.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (qid < 30) {
                        ...
                        Intent intent = new Intent(QuizActivityOverLay.this, ResultActivityOverLay.class);
                        Bundle b = new Bundle();

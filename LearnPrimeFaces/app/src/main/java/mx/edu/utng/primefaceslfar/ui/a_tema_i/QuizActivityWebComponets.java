 ...
 */
public class QuizActivityWebComponets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        grp.clearCheck();
        //Toast.makeText(QuizActivityWebComponets.this," son "+DbHelper.holaadios,Toast.LENGTH_SHORT).show();
        setQuestionView();
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                    Toast.makeText(QuizActivityWebComponets.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (qid < 5) {
                        ...
                        Intent intent = new Intent(QuizActivityWebComponets.this, ResultActivityWebComponents.class);
                        Bundle b = new Bundle();
    ...
    /**
     * Método de cuneta regresiva para el tiempo de quiz
     */
    public void esperar() {

 ...
 */
public class QuizActivityPanel extends AppCompatActivity {
        ...
        butNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(rda.isChecked() || rdb.isChecked() || rdc.isChecked())) {
                    Toast.makeText(QuizActivityPanel.this, "No has contestado la pregunta", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (qid < 25) {
                        ...
                        Intent intent = new Intent(QuizActivityPanel.this, ResultActivityPanel.class);
                        Bundle b = new Bundle();
